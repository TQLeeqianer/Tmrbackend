<div class="sidebar__menu-group">
    <ul class="sidebar_nav">
        ...
        <li class="has-child {{ Request::is(app()->getLocale().'/sales_orders/*') ? 'open':'' }}">
            <a href="#" class="{{ Request::is(app()->getLocale().'/sales_orders/*') ? 'active':'' }}">
                <span class="nav-icon uil uil-receipt"></span>
                <span class="menu-text">Sales Order</span>
                <span class="toggle-icon"></span>
            </a>
            <ul>
                <li><a href="{{ route('sales_orders.index',app()->getLocale()) }}"
                       class="{{ Request::is(app()->getLocale().'/sales_orders') ? 'active':'' }}">Sales Order List</a>
                </li>
            </ul>
        </li>
