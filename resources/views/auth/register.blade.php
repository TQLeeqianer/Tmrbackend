                            ...
                            <div class="card border-0">
                                <div class="card-header">
                                    <div class="edit-profile__title">
                                        <h6>Sign Up Stall Management System</h6>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('signup') }}" method="POST">
                                        ...
                                        <div class="edit-profile__body">
                                            ...
                                            <div class="form-group mb-15">
                                                <label for="password-confirm-field">ConfirmPassword</label>
                                                <div class="position-relative">
                                                    <input id="password-confirm-field" type="password" class="form-control" name="password_confirmation" placeholder="Password">
                                                    <span toggle="#password-confirm-field" class="uil uil-eye-slash text-lighten fs-15 field-icon toggle-password2"></span>
                                                </div>
