            ...
            <div class="breadcrumb-main application-ui mb-30">
                <div class="breadcrumb-action d-flex">
                    ...
                    <div class="action-btn me-10 my-sm-0">
                        <a href="{{route('event.event_list')}}" class="btn radius-md btn-primary bg-primary fs-12 fw-500"><img
            ...
            <div class="col-xxl-3 col-lg-4 mb-25">
                <div class="progress-box px-25 pt-25 pb-10 bg-success radius-xl">
                    <div class="d-flex justify-content-between mb-3">
                        <h6 class="text-white fw-500 fs-16 text-capitalize">Visitors</h6>
                        <span class="progress-percentage text-white fw-500 fs-16 text-capitalize">50%</span>
                    </div>
